        ...
        <div>
            ...
            <div className="main">
                <div className="main-col">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/VKnJf5jn68w?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe>
                </div>
                ...
                <div className="main-col"><iframe width="560" height="315" src="https://www.youtube.com/embed/VKnJf5jn68w?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe></div>
            </div>
        </div>
    )
}
